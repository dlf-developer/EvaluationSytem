  ...
  Teacher: [
    {
      ...
      children: [
        ...
        {
          path: "/fortnightly-monitor/initiate/create/:id",
          element: <Details />,
        },
        ...
        },
        {
          ...
          element: <FortnightlyMonitorEdit />,
        },
  ...
  Observer: [
    {
      ...
      children: [
        ...
        {
          path: "/fortnightly-monitor/form-initiation",
          element: <FortnightlyMonitorInitiation />,
        },
        {
          path: "/fortnightly-monitor/edit/:id",
          element: <FortnightlyMonitorEdit />,
        ...
        {
          path: "/notebook-checking-proforma/form-initiation",
          element: <NoteBookInisiate />,
        },
        {
          path: "/notebook-checking-proforma/report/:id",
          element: <NotebookPDF />,
